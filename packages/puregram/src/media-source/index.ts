...
export interface MediaSourcePath extends Base { type: MediaSourceType.Path; value: string }
export interface MediaSourceUrl extends Base, MediaInputUrlOptions { type: MediaSourceType.Url; value: string }
export interface MediaSourceFileId extends Base { type: MediaSourceType.FileId; value: string }
export interface MediaSourceBuffer extends Base { type: MediaSourceType.Buffer; value: Buffer }
export interface MediaSourceStream extends Base { type: MediaSourceType.Stream; value: Readable }
export interface MediaSourceFile extends Base { type: MediaSourceType.File; value: File }
export interface MediaSourceArrayBuffer extends Base { type: MediaSourceType.ArrayBuffer; value: ArrayBufferLike }
...
export interface MediaSourceToPath extends Base { type: MediaSourceType.Path; value: string }
export interface MediaSourceToBuffer extends Base { type: MediaSourceType.Buffer }
export interface MediaSourceToStream extends Base { type: MediaSourceType.Stream; value: Writable }
...
export class MediaSource {
  static path (path: string, opts: MediaInputOptions = {}): MediaSourcePath {
    if (typeof path !== 'string') throw new TypeError('expected path: string')
  ...
  static stream (stream: Readable, opts: MediaInputOptions = {}): MediaSourceStream {
    if (!(stream instanceof Readable)) throw new TypeError('expected stream: Readable')
    return { type: MediaSourceType.Stream, value: stream, ...opts }
  }
  static file (file: File, opts: MediaInputOptions = {}): MediaSourceFile {
    if (!(file instanceof File)) throw new TypeError('expected file: File')
    return { type: MediaSourceType.File, value: file, ...opts }
  }
  static arrayBuffer (buffer: ArrayBufferLike, opts: MediaInputOptions = {}): MediaSourceArrayBuffer {
  ...
  static base64 (b64: string, opts: MediaInputOptions = {}): MediaSourceBuffer {
    if (typeof b64 !== 'string') throw new TypeError('expected b64: string')
...
export class MediaSourceTo {
  ...
  static buffer (opts: MediaInputOptions = {}): MediaSourceToBuffer {
