...
export interface GetUpdatesParams {
   ...
   * confirmed as soon as getUpdates is called with an offset higher than it
   ...
   * update types. Specify an empty list to receive all updates regardles
 ...
 */
export type getUpdates = (params: Partial<GetUpdatesParams>) => Promise<TelegramUpdate[]>;
