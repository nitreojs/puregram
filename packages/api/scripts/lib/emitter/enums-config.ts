...
export const ENUMS: EnumSpec[] = [
  { exportName: 'AttachmentType', source: { kind: 'literal', values: [
  ...
  { exportName: 'ChatAction', source: { kind: 'literal', values: [
  ...
  { exportName: 'ChatMemberStatus', source: { kind: 'literal', values: [
    'creator', 'administrator', 'member', 'restricted', 'left', 'kicked'
  ] } },
  { exportName: 'BotCommandScopeType', source: { kind: 'literal', values: [
