...
import { Constructor, UpdateName, MessageEventName, MaybeArray } from './types/types'
...
export interface Updates {
  /** Subscribes to specific event(s) and sets up a handler for it(them) */
  on<T = {}>(events: UpdateType.CallbackQuery | 'callback_query', handlers: MaybeArray<Middleware<Contexts.CallbackQueryContext & T>>): this
  on<T = {}>(events: UpdateType.ChannelChatCreated | 'channel_chat_created', handlers: MaybeArray<Middleware<Contexts.ChannelChatCreatedContext & T>>): this
  on<T = {}>(events: UpdateType.ChosenInlineResult | 'chosen_inline_result', handlers: MaybeArray<Middleware<Contexts.ChosenInlineResultContext & T>>): this
  on<T = {}>(events: UpdateType.DeleteChatPhoto | 'delete_chat_photo', handlers: MaybeArray<Middleware<Contexts.DeleteChatPhotoContext & T>>): this
  on<T = {}>(events: UpdateType.GroupChatCreated | 'group_chat_created', handlers: MaybeArray<Middleware<Contexts.GroupChatCreatedContext & T>>): this
  on<T = {}>(events: UpdateType.InlineQuery | 'inline_query', handlers: MaybeArray<Middleware<Contexts.InlineQueryContext & T>>): this
  on<T = {}>(events: UpdateType.Invoice | 'invoice', handlers: MaybeArray<Middleware<Contexts.InvoiceContext & T>>): this
  on<T = {}>(events: UpdateType.LeftChatMember | 'left_chat_member', handlers: MaybeArray<Middleware<Contexts.LeftChatMemberContext & T>>): this
  on<T = {}>(events: UpdateType.Message | 'message', handlers: MaybeArray<Middleware<Contexts.MessageContext & T>>): this
  on<T = {}>(events: UpdateType.EditedMessage | 'edited_message', handlers: MaybeArray<Middleware<Contexts.MessageContext & T>>): this
  on<T = {}>(events: UpdateType.ChannelPost | 'channel_post', handlers: MaybeArray<Middleware<Contexts.MessageContext & T>>): this
  on<T = {}>(events: UpdateType.EditedChannelPost | 'edited_channel_post', handlers: MaybeArray<Middleware<Contexts.MessageContext & T>>): this
  on<T = {}>(events: UpdateType.MigrateToChatId | 'migrate_to_chat_id', handlers: MaybeArray<Middleware<Contexts.MigrateToChatIdContext & T>>): this
  on<T = {}>(events: UpdateType.MigrateFromChatId | 'migrate_from_chat_id', handlers: MaybeArray<Middleware<Contexts.MigrateFromChatIdContext & T>>): this
  on<T = {}>(events: UpdateType.NewChatMembers | 'new_chat_members', handlers: MaybeArray<Middleware<Contexts.NewChatMembersContext & T>>): this
  on<T = {}>(events: UpdateType.NewChatPhoto | 'new_chat_photo', handlers: MaybeArray<Middleware<Contexts.NewChatPhotoContext & T>>): this
  on<T = {}>(events: UpdateType.NewChatTitle | 'new_chat_title', handlers: MaybeArray<Middleware<Contexts.NewChatTitleContext & T>>): this
  on<T = {}>(events: UpdateType.PinnedMessage | 'pinned_message', handlers: MaybeArray<Middleware<Contexts.PinnedMessageContext & T>>): this
  on<T = {}>(events: UpdateType.Poll | 'poll', handlers: MaybeArray<Middleware<Contexts.PollContext & T>>): this
  on<T = {}>(events: UpdateType.PollAnswer | 'poll_answer', handlers: MaybeArray<Middleware<Contexts.PollAnswerContext & T>>): this
  on<T = {}>(events: UpdateType.ChatMember | 'chat_member', handlers: MaybeArray<Middleware<Contexts.ChatMemberContext & T>>): this
  on<T = {}>(events: UpdateType.MyChatMember | 'my_chat_member', handlers: MaybeArray<Middleware<Contexts.ChatMemberContext & T>>): this
  on<T = {}>(events: UpdateType.PreCheckoutQuery | 'pre_checkout_query', handlers: MaybeArray<Middleware<Contexts.PreCheckoutQueryContext & T>>): this
  on<T = {}>(events: UpdateType.ShippingQuery | 'shipping_query', handlers: MaybeArray<Middleware<Contexts.ShippingQueryContext & T>>): this
  on<T = {}>(events: UpdateType.SuccessfulPayment | 'successful_payment', handlers: MaybeArray<Middleware<Contexts.SuccessfulPaymentContext & T>>): this
  on<T = {}>(events: UpdateType.SupergroupChatCreated | 'supergroup_chat_created', handlers: MaybeArray<Middleware<Contexts.SupergroupChatCreatedContext & T>>): this
  on<T = {}>(events: UpdateType.MessageAutoDeleteTimerChanged | 'message_auto_delete_timer_changed', handlers: MaybeArray<Middleware<Contexts.MessageAutoDeleteTimerChangedContext & T>>): this
  on<T = {}>(events: UpdateType.VideoChatScheduled | 'video_chat_scheduled', handlers: MaybeArray<Middleware<Contexts.VideoChatScheduledContext & T>>): this
  on<T = {}>(events: UpdateType.VideoChatStarted | 'video_chat_started', handlers: MaybeArray<Middleware<Contexts.VideoChatStartedContext & T>>): this
  on<T = {}>(events: UpdateType.VideoChatEnded | 'video_chat_ended', handlers: MaybeArray<Middleware<Contexts.VideoChatEndedContext & T>>): this
  on<T = {}>(events: UpdateType.VideoChatParticipantsInvited | 'video_chat_participants_invited', handlers: MaybeArray<Middleware<Contexts.VideoChatParticipantsInvitedContext & T>>): this
  on<T = {}>(events: UpdateType.WebAppData | 'web_app_data', handlers: MaybeArray<Middleware<Contexts.WebAppDataContext & T>>): this
  on<T = {}>(events: UpdateType.ChatJoinRequest | 'chat_join_request', handlers: MaybeArray<Middleware<Contexts.ChatJoinRequestContext & T>>): this
  on<T = {}>(events: UpdateType.ProximityAlertTriggered | 'proximity_alert_triggered', handlers: MaybeArray<Middleware<Contexts.ProximityAlertTriggeredContext & T>>): this
  on<T = {}>(events: MaybeArray<string>, handlers: MaybeArray<Middleware<Contexts.Context & T>>): this
}
