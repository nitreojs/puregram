...
interface MigrateToChatIdContext extends Constructor<MigrateToChatIdContext>, Message, TargetMixin, SendMixin, ChatActionMixin, NodeMixin, PinsMixin, ChatInviteControlMixin, CloneMixin<MigrateToChatIdContext, MigrateToChatIdContextOptions> { }
applyMixins(MigrateToChatIdContext, [Message, TargetMixin, SendMixin, ChatActionMixin, NodeMixin, PinsMixin, ChatInviteControlMixin, CloneMixin])
