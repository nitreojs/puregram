...
/// Generation date: 11.05.2021 16:37:36 MSK
...
export interface SetWebhookParams {
   ...
   */
  certificate?: Interfaces.InputFile;
  /**
...
export interface SendAnimationParams {
   ...
   */
  animation: Interfaces.InputFile;
  /**
...
export interface SendVideoNoteParams {
   ...
   */
  video_note: Interfaces.InputFile;
  /**
   * Duration of sent video in seconds
   */
  duration?: number;
