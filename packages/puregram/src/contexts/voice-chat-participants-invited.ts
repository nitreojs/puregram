...
class VoiceChatParticipantsInvitedContext extends Context {
  ...
  constructor(telegram: Telegram, payload: TelegramMessage) {
    super(telegram, 'voice_chat_participants_invited');
...
inspectable(VoiceChatParticipantsInvitedContext, {
  serialize(context: VoiceChatParticipantsInvitedContext) {
    return {
      id: context.id,
      from: context.from,
      ...
      voiceChatParticipantsInvited: context.voiceChatParticipantsInvited
    };
  }
});

export { VoiceChatParticipantsInvitedContext };
