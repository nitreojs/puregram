...
Контекст, наследуемый от классов `Message` и `Context`;
...
* [`hasText`](#hastext)
* [`hasEntities(type?: EntityType)`](#hasentitiestype-entitytype)
* [`hasCaption`](#hascaption)
* [`hasCaptionEntities(type?: EntityType)`](#hascaptionentitiestype-entitytype)
* [`attachments`](#attachments)
* [`hasAttachments(type?: AttachmentType)`](#hasattachmentstype-attachmenttype)
* [`getAttachments(type?: AttachmentType)`](#getattachmentstype-attachmenttype)
* [`isForward`](#isforward)
