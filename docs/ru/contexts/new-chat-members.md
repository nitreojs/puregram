...
**Вызывается, когда в чате прибавляется один или несколько пользователей.**

_Бот может быть одним из них!_
...
**Возвращает пользователей, которые вступили в чат.**

```ts
context.eventMembers // => User[]
```
